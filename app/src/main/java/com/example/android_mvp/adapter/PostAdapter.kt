...
import com.example.android_mvp.activity.MainActivity
import com.example.android_mvp.activity.PostDetailsActivity
    ...
    private fun deletePostDialog(post: Post) {
        ...
        Utils.customDialog(activity, title, body, object : Utils.DialogListener {
            override fun onPositiveClick() {
                activity.mainPresenter.apiPostDelet(post)
            }
